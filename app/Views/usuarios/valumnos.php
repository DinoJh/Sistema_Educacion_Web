...
function guardarUsuario(){
    ...
    setTimeout(function(){
        openCargar();
        $.post("<?=base_url('/usuarios/nuevo')?>",data,function(r){r=JSON.parse(r);closeCargar();if(r.ok){alertar(r.msg,'alert alert-success');setTimeout(()=>cargarFuncion('/usuarios/alumnos','Usuarios','Alumnos',''),1500);}else alertar(r.msg,'alert alert-danger');});
    }, 400);
}
}
</script>

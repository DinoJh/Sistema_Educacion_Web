<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    <button class="btn btn-primary" onclick="clAbrir('ov-nuevousuario');document.getElementById('nuevoPerf').value=2">
        <i class="ti-plus me-1"></i>Nuevo Profesor
    </button>
</div>
<div class="card"><div class="card-body p-0">
<table class="table mb-0">
<thead><tr>
    <th>Profesor</th><th>Especialidad</th><th>Grado</th><th>Usuario</th><th>Cursos</th><th>Estado</th><th>Acciones</th>
</tr></thead>
<tbody>
<?php foreach($usuarios as $u): ?>
<tr>
    <td><div class="d-flex align-items-center gap-2">
        <div style="width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#06b6d4);display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:700;flex-shrink:0;">
        ...
        <div>
            ...
            <small class="text-cl-muted"><?=$u->usua_email?></small>
        </div>
    </div></td>
    <td><small style="color:var(--cl-accent2);"><?=$u->prof_especialidad?></small></td>
    ...
    <td>
        ...
        <button class="btn btn-xs btn-outline-danger" style="padding:2px 8px;font-size:.7rem;"
                onclick="eliminarUsuario(<?=$u->usua_ide?>)">Eliminar</button>
    </td>
</tr>
<?php endforeach; ?>
<?php if(empty($usuarios)): ?>
<tr><td colspan="7" class="text-center py-4 text-cl-muted">No hay profesores registrados.</td></tr>
<?php endif; ?>
</tbody>
</table>
</div></div>

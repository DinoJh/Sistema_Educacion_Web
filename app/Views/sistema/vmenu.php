                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    <div class="flex-shrink-0">
                                        <img class="img-sm rounded-circle" src="<?= base_url("public/img/usuario.webp"); ?>" alt="Profile Picture" loading="lazy">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="list-group list-group-borderless h-100 py-3">
                                            <a href="#" class="list-group-item list-group-item-action" onclick="$('#misDatos').modal('show');">
                                                <i class="demo-pli-male fs-5 me-2"></i> Mis datos
                                            </a>
                                            <a href="#" class="list-group-item list-group-item-action" onclick="$('#cambiarClave').modal('show');">
                                                <i class="ti ti-key fs-5 me-2"></i> Cambiar clave
                                            </a>
                                            <a href="#" class="list-group-item list-group-item-action" onclick="$('#contacto').modal('show');">
                                                <i class="demo-pli-computer-secure fs-5 me-2"></i> Contacto
                                            </a>
                                            <a href="#" class="list-group-item list-group-item-action" onclick="$('#cerrarSesion').modal('show');">
                                ...
                                <li class="nav-item has-sub">
                                    ...
                                    <ul class="mininav-content nav collapse show">
                                        <?php foreach ($reg as $r) : ?>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" onclick="cargarFuncion(
                                                '<?php echo $r["url"]; ?>',
                                                '<?php echo $r["modulo"]; ?>',
                                                '<?php echo $r["nombre"]; ?>',
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-end">
                                ...
                                <a href="<?php echo base_url("/cerrarsesion"); ?>" type="button" class="btn btn-primary">Cerrar sesión</a>
                            </div>
                        </div>
                    </div>
